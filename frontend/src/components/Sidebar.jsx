...
export default function Sidebar({ currentPage, onChangePage }) {
  return (
    <aside className="w-64 bg-gradient-to-b from-emerald-950 via-teal-950 to-emerald-950 text-emerald-50 flex flex-col border-r border-emerald-900/80 shadow-xl">
